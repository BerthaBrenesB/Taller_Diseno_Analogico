...
# ACDS 20.1 720 win32 2022.01.20.09:26:43
# ----------------------------------------
...
# ----------------------------------------
# If suma_flotante is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "suma_flotante"
}
...
ensure_lib                                            ./libraries/nios_custom_instr_floating_point_2_combi_0
vmap       nios_custom_instr_floating_point_2_combi_0 ./libraries/nios_custom_instr_floating_point_2_combi_0
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/fpoint2_combi.vhd"                 -work nios_custom_instr_floating_point_2_combi_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/FPMinMaxFused/FPMinMaxFused.vhd"   -work nios_custom_instr_floating_point_2_combi_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/FPCompareFused/FPCompareFused.vhd" -work nios_custom_instr_floating_point_2_combi_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/FPNeg_Abs/FPNeg.vhd"               -work nios_custom_instr_floating_point_2_combi_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/FPNeg_Abs/FPAbs.vhd"               -work nios_custom_instr_floating_point_2_combi_0
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/suma_flotante.v"                                                                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L nios_custom_instr_floating_point_2_combi_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L nios_custom_instr_floating_point_2_combi_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
