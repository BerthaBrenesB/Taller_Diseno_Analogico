...
mkdir -p ./libraries/nios_custom_instr_floating_point_2_combi_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fpoint2_combi.vhd"                 -work nios_custom_instr_floating_point_2_combi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_combi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPMinMaxFused/FPMinMaxFused.vhd"   -work nios_custom_instr_floating_point_2_combi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_combi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPCompareFused/FPCompareFused.vhd" -work nios_custom_instr_floating_point_2_combi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_combi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPNeg_Abs/FPNeg.vhd"               -work nios_custom_instr_floating_point_2_combi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_combi_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/FPNeg_Abs/FPAbs.vhd"               -work nios_custom_instr_floating_point_2_combi_0 -cdslib ./cds_libs/nios_custom_instr_floating_point_2_combi_0.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/suma_flotante.v"                                                                                                                                                    
fi
